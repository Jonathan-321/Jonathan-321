...
- **Agent Evals** — memory-mode ablations and needle-in-haystack benchmarks for long-running ReAct agents ([agentic](https://github.com/Jonathan-321/agentic))
- **Applied AI for Science** — 3D volumetric segmentation on ancient scroll CT scans ([vesuviusChallenge](https://github.com/Jonathan-321/vesuviusChallenge)), historical document layout recognition ([RenAIssance](https://github.com/Jonathan-321/RenAIssance-GSoC-2025))

**Stack** &ensp; Python · PyTorch · scanpy · scikit-learn · Docker · AWS

---

<sub>[jonathanmuhire.com](https://jonathanmuhire.com)</sub>
